 ...
 * @package PrestaShopWebservice
 */
class classes_PrestaShopWebservice
{
	...
	*/
	...
	protected function executeRequest($url, $curl_params = array())
	{
		...
		if (array_key_exists('PSWS-Version', $headerArray))
		{
			...
			if (
				version_compare(classes_PrestaShopWebservice::psCompatibleVersionsMin, $headerArray['PSWS-Version']) == 1 ||
				version_compare(classes_PrestaShopWebservice::psCompatibleVersionsMax, $headerArray['PSWS-Version']) == -1
			)
