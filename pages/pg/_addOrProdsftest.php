...
switch ($maket_sh) {
    ...
    case "3":
        ...
        break;
    default:
        $query = "INSERT INTO order_product (ORDER_ID, TOTAL, PRICE,p_names,summ,units,fast,dates_rdy,TEMP_PR,SIZE,cshivka,template,view_press,view_diz, flags,num_prod_ord,cl_file,print_diz,press_diz,sum_press,comment,price_sys,add_date,code_stat) 
