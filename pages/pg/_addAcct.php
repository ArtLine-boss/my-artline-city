                ...
                <div class="btn-group">
                    ...
                    <ul class="dropdown-menu">
                        <?php if ($firm_parent == 1) { ?>
                            ...
                            <li><a href='proc/acct_prot.php?id=<? echo $idAcct ?>' target='_blank'>Счет-протокол</a>
                            </li>
                            ...
                            <li><a href='proc/acct_prot2.php?id=<? echo $idAcct ?>' target='_blank'>Счет-протокол(с
                                    печатью)</a></li>
                            <li><a href='proc/acct_prot4.php?id=<? echo $idAcct ?>' target='_blank'>Счет-протокол(На
                                    один
                                    листик)</a></li>
                        ...
                        <?php } else if ($firm_parent == 2) { ?>
                            ...
                            <li><a href='proc/acct_prot2_m.php?id=<? echo $idAcct ?>' target='_blank'>Счет-протокол(с
                                    печатью)</a></li>
                            <li><a href='proc/acct_prot4_m.php?id=<? echo $idAcct ?>' target='_blank'>Счет-протокол(На
                                    один
                                    листик)</a></li>
                        ...
                        <?php if (in_array(1, $ACCESS_ROLES)) { ?>
                            <li>
                                <a onclick="javascript: window.open('/www/core/print.php?m=orders&u=ordersCheck&a=printOrderCheck&idAcct=<? echo $idAcct; ?>', 'Товарный чек');"
                                   style="cursor: pointer">Товарный чек</a></li>
                        <?php } ?>
                        <li><a onclick='deltn()'>Удаление ТН</a></li>
                        <li>
                            <a onclick="func_mail(<? echo $idAcct ?>,<? echo $client_id ?>,'<? echo $email ?>', <? echo $firm_parent; ?>)">Отправить
                                на Email</a></li>
        ...
        <div class="modal-dialog  modal-lg">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <div class="row">
                        <div class="col-md-2">
                            <button type="button" id='confirm1' onclick='print_act_no_nds()' class="btn btn-default">
                                Печать
                            </button>
                        </div>
                ...
                <div class="modal-body">
                    ...
                    <form class='form-signin' method='post' action='_addOrProdsftest.php' enctype='multipart/form-data'
                        ...
                        <div class='row'>
                            ...
                            <div class="col-md-4">
                                <select class="js-example-basic-single js-states form-control" id="directoryCodeStat"
                                        name="directoryCodeStat" tabindex='1'>
                                    <?
                        ...
                        <div class='row'>
                            ...
                            <div class='col-md-4'><input type='text' id='p_names' size='100%' style='width:100%'
                                                         name='p_names' value=''
                        ...
                        <div class='row'>
                            ...
                            <div class='col-md-2'>
                                <div class="form-group"><label>Переплет</label><br><label>Сторона переплета:</label><br><label>Материал
                                        переплета:</label>
                                </div>
                            </div>
                            <div class='col-md-3'>
