			...
			<div class='masthead'>
				...
				<?php
					...
					if ($row = mysql_fetch_row($result)) {
						...
						echo "<h4 class='text-muted'>БАЛАНС: $balaceSum <br> &nbsp; &nbsp; &nbsp; В работе $balaceJob; <br>&nbsp; &nbsp; &nbsp; Готовы $balaceRdy; <br>&nbsp; &nbsp; &nbsp; Выписаны ТН $balaceTN; <br>&nbsp; &nbsp; &nbsp; Оплаты $balaceOpl </h4>";
						echo '</div>';
						...
						if ($admin == '4' OR $login == '026' OR $login == '027' or $login == '032'){
						...
						<script>
							...
							function get_price1(stra) {
								...
								for (var i = 1; i < part; i++) {
									...
									price_p = 0;
									//Плотерная резка
									if ((document.getElementById('p_cut2_' + i).checked) && (document.getElementById('p_size_cut_' + i).value != "")) {
							...
							function chosenSelected(e) {
								...
								if(p_eq.options[p_eq.selectedIndex].text == "Xerox iGen 150") {
										...
										<script>
											...
											$(function () {
												...
												$('#confirm').on('click', function () {
													...
													document.getElementById('fr').src = 'proc/act_.php?id=' + idAcct + "&no_nds=0";
											...
											function showacct(id) {
												document.getElementById('fr').src = 'proc/act.php?id=' + id + "&no_nds=0";
												$('#myacct').modal('show');
											}
