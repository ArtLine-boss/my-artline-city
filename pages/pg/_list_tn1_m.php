...
function addtn() {
   ...
   if (document.getElementById('no_nds').checked) {
	...
	if (i_err == 0){
		...
		document.getElementById('fr').src = 'proc/ttn_view_m.php?eid='+idAcct+'&face_to='+face_to+'&to_face='+to_face+'&pricep='+pricep+'&list_put='+list_put+'&number='+number+'&seriass='+seriass+'&srt='+srt+'&flafff='+flafff+'&dates='+dates+'&no_nds='+no_nds+'&num_dover='+num_dover+'&date_dover='+date_dover+'&pogr='+pogr+'&razg='+razg;
		} else {
					document.getElementById('tn_err8').style.display = 'block';
		}
...
var 	i_err = 0;
  ...
  if (document.getElementById('no_nds').checked) {
	...
	if (i_err == 0){
		...
		document.getElementById('fr').src = 'proc/ttn_save_m.php?eid='+idAcct+'&face_to='+face_to+'&to_face='+to_face+'&pricep='+pricep+'&list_put='+list_put+'&number='+number+'&srt='+srt+'&flafff='+flafff+'&seriass='+seriass+'&dates='+dates+'&no_nds='+no_nds+'&num_dover='+num_dover+'&date_dover='+date_dover+'&pogr='+pogr+'&razg='+razg+'&is_not_exp='+is_not_exp;
