...
/*сведения о машине водителе*/
 ...
 if($flag_post == 1){
  ...
  $pdf->Cell(50,6,'Общество с ограниченной ответственностью "Мечта клиента"',0,0);
 }
 ...
 $pdf->Cell(50,6,'Общество с ограниченной ответственностью "Мечта клиента", 224030, г. Брест, ул. Карбышева, 74-9',0,0);
  $pdf->Ln();
...
$pdf->Cell($tbl_row_w*4.5,$tbl_row_h,'Общество с ограниченной ответственностью', 'L' ,0, 'L');
 $pdf->SetFont('ArialMT','', 7);
