...
$query = "select order_id , num_tm , dolj_pol , fio_pol , num_dov , date_dol , flg , dates_ , seria ,val_, no_nds,pricep, put_list, POGRUZKA, RAZGRUZKA from tn_list_par where id = ".$ID1 ;
$result = mysql_query($query) or die($query);
if($row = mysql_fetch_row($result)){
	$eid = $row[0];
	$number = $row[1];
