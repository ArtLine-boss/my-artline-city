...
<TD VALIGN=TOP COLSPAN=20 border=0010>'.iconv("UTF-8", "cp1251", classes_accordUsers::getPOST($users, classes_accordUsers::ACCORD_TYPE_MA)).' '.iconv("UTF-8", "cp1251", classes_accordUsers::getFIO($users, classes_accordUsers::ACCORD_TYPE_MA)).'
</TR>
<TR>
<TD VALIGN=TOP BORDERCOLOR=#ffffff><FONT SIZE=5>&nbsp;</FONT>
<TD VALIGN=TOP BORDERCOLOR=#ffffff><FONT SIZE=5>&nbsp;</FONT>
