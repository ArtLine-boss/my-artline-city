...
// $pdf->Cell(12,7,'',0,0);
// $pdf->Cell(35,7,'',0,0);
// $pdf->Cell(1,7,'Итого:',0,0);
// $pdf->Cell(16,2,'',0,0);
// $pdf->Cell(18,7,number_format($summ_no_nds_all , 2, ',', ' '),1,0,'R');
// $pdf->Cell(12.4,7,'',0,0);
// $pdf->Cell(18,7,number_format($sum_nds_all , 2, ',', ' '),1,0,'R');
// $pdf->Cell(18,7,number_format($summ_all , 2, ',', ' '),1,0,'R');
