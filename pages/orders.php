...
<html lang="ru">
    ...
    <body>
        <div id="container">
            ...
            <div id="page-wrapper">
				...
				<div class="row" style="margin-bottom: 10px">
					<div class="col-md-3">
						<input id="getCurrentOrderId" type="number" class="form-control" placeholder="Перейти в заказ" style="width: 60%; display: inline;" onchange="getCurrentOrder()">
                ...
                <ul class="nav nav-tabs" id="myTab">
                    ...
                    <li><a href="#profile" data-toggle="tab">Заказы в  работе <span class="label label-danger"><?php echo $count_voz;?></span> <span class="label label-success"><?php echo $count_rdy;?></span> </a></li>
                ...
                <div class="tab-content">
                        ...
                        <div class="tab-content">
                            ...
                            <div class="tab-pane active" id="tab_a">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <div class="input-group" >
                                            <input type="text" name="dateStart" id="dateStart" class="datepicker form-control" value="<?php echo $DT1; ?>" size="8" />
                                            <span class="input-group-addon">по</span>
                                            <input type="text" name="dateEnd" id="dateEnd" class="datepicker form-control" value="<?php echo $DT2; ?>" size="8"/>
                                        </div>
                                    </div>
                                    <div class="col-md-1"></div>
                                    <div class="col-md-2">
                                        <select id = 'user_list' onchange='crt()' class="form-control"  ><option value='0'>Все</option>
                                            <?php
                                ...
                                <div class="panel-body">
                                    <table  width="100%"  class="table table-striped table-bordered table-hover " cellspacing="0" id="tb_a"  >
                                        <thead>
                                            <tr>
                                                <th>+/-</th>
                                                <th>#</th>
                            ...
                            <div class="tab-pane" id="tab_p">
                                ...
                                <div class="panel-body">
                                    <table  width="100%"  class="table table-striped table-bordered table-hover " cellspacing="0" id="tb_p"  >
                                        <thead>
                                            <tr>
                                                <th>+/-</th>
                                                <th>#</th>
                            ...
                            <div class="tab-pane" id="tab_o">
                                <div class="panel-body">
                                    <table  width="100%"  class="table table-striped table-bordered table-hover " cellspacing="0" id="tb_o"  >
                                        <thead>
                                            <tr>
                                                <th>Номер заказа</th>
                                                <th>Сумма</th>
                        ...
                        <div class="row">
                            <div class="col-lg-12">
                                <div class="panel panel-default">
                                    <div class="row">
                                        <div class='col-md-2'><button type='button' class='btn btn-default form-control'  onclick='_prod_rdy()' >Сдано заказчику</button></div>
                                        <div class='col-md-2'><button type='button' class='btn btn-default form-control'  onclick='_prod_brak()' >Брак/Отказ</button></div>
                                        <?php
                                            if ($admin != '2' and $admin != '7' and $admin != '6' and $admin != '5') {
                    ...
                    <div class="tab-pane" id="report_of_manager">
                    	<div class="row">
                    		<div class="col-md-3">
                    			<button type="button" class="btn btn-default form-control" onclick="loadReportOfManager()">Обновить</button>
                    		</div>
                    	</div>
                    	<div class="row">
                    		<div class="col-md-6">
                    			<input class="form-control input-sm" id="searchOfReportManager" type="text" placeholder="Поиск" oninput="tableSearch('searchOfReportManager','table_report_manager')">
                    		</div>
                    	</div>
                    	<div class="row">
                    		<div class="panel-body">
                        		<table  width="100%"  class="table table-striped table-bordered table-hover responsive nowrap " cellspacing="0" id="table_report_manager"  >
                        			<thead>
                        			<tr>
                        				...
                        				<th style="cursor:pointer" class="sort"><i class="fa fa-fw fa-sort"></i>Наименование</th>
                        				<th style="cursor:pointer" class="sort"><i class="fa fa-fw fa-sort"></i>Дата добавления</th>
                        				<th style="cursor:pointer" class="sort"><i class="fa fa-fw fa-sort"></i>Дата отправки в работу</th>
                    ...
                    <div class="tab-pane" id="not_task">
                        <div class="row">
                            <div class="panel-body">
                                <table  width="100%"  class="table table-striped table-bordered table-hover responsive nowrap " cellspacing="0" id="table_not_task"  >
                                    <thead>
                                        <tr>
											<?php if($admin == '4'): ?>
            ...
            <div class="modal-dialog  modal-lg">
                <div class="modal-content">
                    ...
                    <div class="modal-body" >
                        <div class="row">
                            <div class="col-md-12">
                                <iframe  id = 'fr' src="" width="100%" height="700" align="left">Ваш браузер не поддерживает плавающие фреймы!</iframe>
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" data-dismiss="modal" class="btn btn-default">Отмена</button>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-3">
                                ...
                                <div class="modal-footer">
                                    <button type="button" data-dismiss="modal" class="btn btn-default">Отмена</button>
                                    <a onclick="fun_opl()"><button type="button" class="btn btn-primary" >Добавить</button></a>
                                </div>
                </div>
            </div>
        </div>
        ...
        <div id="smena_cl" class="modal fade " tabindex="-1" data-backdrop="static" data-keyboard="true" style="display: none;">
            <div class="modal-dialog  modal-lg">
                <div class="modal-content ">
                    <div class="modal-header">
                        <button class="close" type="button" data-dismiss="modal">×</button>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-9"><div class="block1"><input type="text" id="search1" class="inputSearch" ></div></div>
                        </div>
                        <div class="row">
                    ...
                    <div class="modal-footer">
                        <button type="button" data-dismiss="modal" class="btn btn-default">Отмена</button>
                        <a onclick="sscm()"><button type="button" class="btn btn-primary" >Изменить</button></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="smena_dt" class="modal fade " tabindex="-1" data-backdrop="static" data-keyboard="true" style="display: none;">
            <div class="modal-dialog">
                <div class="modal-content ">
                    <div class="modal-header">
                        <button class="close" type="button" data-dismiss="modal">×</button>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            <div class="col-md-3"><div class="block1"><label></label></div></div>
                            <div class="col-md-2"><div class="block1"><label>Дата:</label></div></div>
                            <div class="col-md-4"><div class="block1"><input type="date" id="dt_sme"   ></div></div>
                            <div class="col-md-3"><div class="block1">	<input type="hidden" id = "id_dt_sme" value=""></div></div>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" data-dismiss="modal" class="btn btn-default">Отмена</button>
                        <a onclick="save_dt_acct()"><button type="button" class="btn btn-primary" >Изменить</button></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <!-- /#Модальные окна -->
        <div id="myaddacct" class="modal fade " tabindex="-1" data-backdrop="static" data-keyboard="true" style="display: none;">
            <div class="modal-dialog  modal-lg">
                <div class="modal-content ">
                    <div class="modal-header">
                        <button class="close" type="button" data-dismiss="modal">×</button>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="row">
                            <div class="col-md-2"><div class="block1"><label>Поиск:</label></div></div>
                            <div class="col-md-9"><div class="block1"><input type="text" id="search2" class="inputSearch" ></div></div>
                            <div class='col-md-1'><div class='block1'><a onClick="window.open('clients.php', 'Добавление нового клиента', 'Toolbar=0, Scrollbars=1, Resizable=0, Location=0, Width=1024, resize=no, Height=768');"><button type="button" class="btn btn-sm"><span class="glyphicon glyphicon-plus-sign"></span></button></a></div></div>
                        </div>
                        <div class="row">
                            <div class="col-md-12"> </div>
                        </div>
                        <div class="row">
                            ...
                            <div class='col-md-10'>
                                <div class='block1'>
                                    <select id = 'orderClient' size='10' style='overflow:auto;' onchange="selectClient(this)">
                                        <?php
                                            echo " <optgroup label=''>";
                                            echo $srt_cl;
                                            echo "</select> &nbsp";
                    ...
                    <div class="modal-footer">
                        <button type="button" data-dismiss="modal" class="btn btn-default">Отмена</button>
                        <a onclick="preaddorders()"><button type="button" class="btn btn-primary" id = 'lock_add'>Добавить</button></a>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div id="filesa" class="modal fade " tabindex="-1" data-backdrop="static" data-keyboard="true" style="display: none;">
            <div class="modal-dialog modal-lg">
                <div class="modal-content ">
                    <div class="modal-header">
                        <button class="close" type="button" data-dismiss="modal">×</button>
                    ...
                    <div class="modal-body">
                        <form  class='form-signin' method='post' action='ajax_php_sql_post.php' enctype='multipart/form-data' id = 'forms'>
        ...
        <!-- /#Модальные окна -->
        <div id="planJob" class="modal fade " tabindex="-1" data-backdrop="static" data-keyboard="true" style="display: none;">
            <div class="modal-dialog modal-lg">
                <div class="modal-content ">
                    <div class="modal-header">
                        <button class="close" type="button" data-dismiss="modal">×</button>
                    ...
                    <div class="modal-body">
                        ...
                        <div class="modal-footer"><button type="button" data-dismiss="modal" class="btn btn-default">Отмена</button>
                            <a onclick="_add_plan_job2()"><button type="button" class="btn btn-primary">Заказать</button></a>
                        </div>
                    </div>
                </div>
            </div>
                    ...
                    <div class="modal-body">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                ...
                                <button type="button" class="btn btn-info btn-circle" onclick='_add_plan_job4()' ><i class="fa fa-search"></i></button>
                            </div>
                            <div class="row">
                                <div class="col-md-1">  &nbsp; </div>
                            </div>
                        ...
                        <div class="modal-footer"><button type="button" data-dismiss="modal" class="btn btn-default">Отмена</button>
                            <a onclick="_add_plan_job5()"><button type="button" class="btn btn-primary">Заказать</button></a>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <!--------------------------------------------------------------------------------------------------------->
        <!------------------------------------------addContract --------------------------------------------------------------->
        <div id="addContract" class="modal fade bd-example-modal-lg"  tabindex="-1" data-backdrop="static" data-keyboard="false" style="display: none;">
            <div class="modal-dialog  modal-lg">
                <div class="modal-content">
                    <div class="modal-header">
                        <button class="close" type="button" data-dismiss="modal">×</button>
                    ...
                    <div class="modal-body" >
                        ...
                        <div class='row'>
                            ...
                            <div class='col-md-3'> <input type='text'  size = 12 id='addContract_num_doc' class=" form-control"></div>
                            <div class='col-md-1'> <label>от:</label></div>
                            <div class='col-md-3'> <input type='date'  id='addContract_num_doc_date' class="form-control"></div>
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" data-dismiss="modal" class="btn btn-default">Отмена</button>
                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body" >
                        <div class="row">
                            ...
                            <div class="col-md-4">
                                <label class="radio-inline">
                                    <input type="radio" name="addParentCompany_parent_company"  id = 'addParentCompany_parent_company_a' value="1" checked>ОДО АртЛайнСити
                                </label>
                                <label class="radio-inline">
                                    <input type="radio" name="addParentCompany_parent_company" id = 'addParentCompany_parent_company_m' value="2">ЧУП Мечта клиента
                                </label>
                            </div>
                        </div>
                    </div>
