<?
	...
	if ($admin == '4' ){
		$count_off = 0;
		$sql = 'select  op.template from order_product op where status in (12) AND NOT EXISTS (select lt.flags from lock_task lt where lt.id_prod = op.id AND lt.flags = 1)';	
	...
	if($login == '026' OR  $login == '027' or $login == '033' or $login == '032'){
	echo '<li>
	<a class="menu_a" href="stock.php"><i class="fa fa-money fa-fw"></i> Склад</a>
	</li>';}
	if (  $admin == '5' OR $admin == '6' OR  $admin == '7'){	echo ' <li><a class="menu_a" href="task_p_d.php"><i class="fa fa-th-list fa-fw"></i>Подготовка файлов </a></li>';}
	if ($admin == '4' ){	echo ' <li><a class="menu_a" href="task_p_d.php"><i class="fa fa-th-list fa-fw"></i>Подготовка файлов <span class="label label-info">'.$count_off.'</span> </a></li>';}
	
	if($admin == '4' OR  $admin == '9' OR $admin == '2' ){
	...
	echo '<li>
	<a class="menu_a" href="Reports/diz.php"><i class="fa fa-money fa-fw"></i> Загруженность дизайнеров</a>
	</li>';
	}
	if($login == '8' || $login == '29'){
	
	echo '<li>
	<a class="menu_a" href="Reports/mang_bank.php">Оформленные заказы</a>
	</li>';
	}	
	if($admin == '2'){
	...
	if ($admin == '4'){
	echo '<li><a class="menu_a" href="task.php"><i class="fa fa-th-list fa-fw"></i>Производство</a></li>
	<li><a class="menu_a" href="#" ><i class="fa fa-file-text-o fa-fw"></i> Отчет <span class="fa arrow"></span></a>
	<ul class="nav nav-second-level">
	<li><a class="menu_a" href="Reports/mang_bank.php">Оформленные заказы</a></li>
	</ul>
	<ul class="nav nav-second-level">
	...
	<ul class="nav nav-second-level">
	<li><a class="menu_a" href="Reports/reportOrder.php">Отчет в XLS</a></li>
	</ul>
	</li> 
