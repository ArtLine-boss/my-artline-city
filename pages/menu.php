...
if ($admin == '5' or $admin == '6' or $admin == '7') {
    echo ' <li><a class="menu_a" href="task_p_d.php"><i class="fa fa-th-list fa-fw"></i>Подготовка файлов </a></li>';
}
if ($admin == '4') {
    echo ' <li><a class="menu_a" href="task_p_d.php"><i class="fa fa-th-list fa-fw"></i>Подготовка файлов <span class="label label-info">' . $count_off . '</span> </a></li>';
}
