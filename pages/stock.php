    ...
    <div id="page-wrapper">
        ...
        <div class="tab-content">
            <div class="tab-pane active" id="home">
                <button type='button' class='btn btn-default' onClick='_rev_mat()'>Приход/Списание</button>
                <button type='button' class='btn btn-default' onClick='_matArh()'>Архив</button>
                <div class="panel-body">
                    <table width='100%' class="table table-striped table-bordered table-hover responsive nowrap "
                           cellspacing="0" id="tb_mat">
                        <thead>
                        <tr>
                            <th></th>
                            <th></th>
        ...
        <div class="modal-content ">
            ...
            <div class="modal-body">
                ...
                <div class="row">
                    ...
                    <div class="col-md-2"><input type="text" id="seriass" name="seriass"
                                                 onKeyUp="this.value = this.value.replace (/[^А-Я]/, '')" size='2'
                                                 value="" disabled></div>
                </div>
                ...
                <hr>
                <button type='button' class='btn btn-default' id='add_bnt' onClick='add_mat_ttn()' disabled>Добавить
                </button>
                <table width='100%' class="table table-striped table-bordered table-hover responsive nowrap "
                       cellspacing="0" id="tb_list_mat">
                    <thead>
                    <tr>
                        <th></th>
                        <th>Наименование</th>
                ...
                <div class="modal-footer">
                    ...
                    <button type="button" class="btn btn-primary" onclick="add_ttn_base()" id='add_bnt1'>Добавить
                    </button>
                    <input type='hidden' id='id_rev' value=''>
                    <button type="button" class="btn btn-primary" onclick="edit_ttn_base()" id='edit_bnt' disabled>
                        Изменить
                    </button>
                </div>
            </div>
...
<!-- /#Добавление нового поставщтка -->
<div id="add_ttn_mat" class="modal fade " tabindex="-1" data-backdrop="static" data-keyboard="true"
     style="display: none;">
            ...
            <div class="modal-body">
                ...
                <div id="block1" style="display:block;">
                    <div class="row">
                        ...
                        <div class="col-md-3"><select id='add_mat' name='add_mat' class='selectpicker'
                ...
                <div id="she1" style="display: none;">
                    <div class="row">
                        <div class="col-lg-4">
                            <label>Поиск: <input type="text" id="plugins4_q" value="" class="input"
                                                 style="margin:0em auto 1em auto; display:block; padding:4px; border-radius:4px; border:1px solid silver;"></label>
...
<!-- /#Модальные окна -->
<div id="list_mat" class="modal fade " tabindex="-1" data-backdrop="static" data-keyboard="false"
     style="display: none;">
    <div class="modal-dialog modal-lg">
        <div class="modal-content ">
            <div class="modal-header">
            ...
            <div class="modal-body">
                ...
                <div class="modal-footer">
                    ...
                    <a onclick="_add_plan_job2()">
                        <button type="button" class="btn btn-warning">Списать</button>
                    </a>
                    <a onclick="_add_plan_job3()">
                        <button type="button" class="btn btn-primary">Оприходовать</button>
                    </a>
                </div>
            </div>
        </div>
...
<!-- /#Модальные окна -->
<div id="edit_mat" class="modal fade " tabindex="-1" data-backdrop="static" data-keyboard="false"
     style="display: none;">
    <div class="modal-dialog modal-lg2">
        <div class="modal-content ">
            <div class="modal-header">
            ...
            <div class="modal-body">
                ...
                <div class='row'>
                    ...
                    <div class='col-md-6'><input type='text' class="form-control" id='priceMaterial_edit' value=''>
                    </div>
                </div>
                <div class='row'>
                    <div class='col-md-2'></div>
...
<div id="add_opl" class="modal fade " tabindex="-1" data-backdrop="static" data-keyboard="false" style="display: none;">
    <div class="modal-dialog">
        <div class="modal-content">
                ...
                <div class="row">
                    <div class="col-md-3">
                        <div class="block1">
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="block1"><label>№ заказа:</label></div>
                                </div>
                                <div class="col-md-3">
                                    <div class="block1"><input id='num' type='text' disabled value='0'/></div>
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="block1"><label>Сумма:</label></div>
                                </div>
                                <div class="col-md-3">
                                    <div class="block1"><input id='sum' type='text' value='0'/></div>
                                </div>
                            </div>
                            <div class='row'>
                                <div class='col-md-3'>
                                ...
                                <div class='col-md-2'>
                                    <div class='block1'><input type='date' id='date_opl' name='date_opl'></div>
                                </div>
                            </div>
                            <div class='row'>
                                <div class='col-md-3'>
                                ...
                                <div class='col-md-9'>
                                    <div class='block1'>
                                        <div class="form-group" id='radio_chk'>
                                            <label class="radio-inline">
                                                <input type="radio" name="view_opl" id="view_opl1" value="5" checked>
                                                безнал
                                            </label>
                            ...
                            <div class='row'>
                                <div class='col-md-3'>
                                    <div class='block1'><label>Комментарий:</label></div>
                                </div>
                                <div class='col-md-9'><textarea class="form-control" rows="3" id='list_comm'></textarea>
                                </div>
                            </div>
                        </div>
            ...
            <div id="addTree" class="modal fade " tabindex="-1" data-backdrop="static" data-keyboard="true"
                 style="display: none;">
                <div class="modal-dialog modal-lg">
                    <div class="modal-content ">
                        <div class="modal-header">
                        ...
                        <div class="modal-body">
                            <div class='row'>
                                ...
                                <div class="col-lg-5"><input type='text' id="name_tree" size='70'><input type='hidden'
                                                                                                         id="id_tree">
                                </div>
                            </div>
                            <div class='row'>
