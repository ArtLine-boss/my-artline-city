<?
	...
	if( isset( $_GET['list_id'] ) ) {
		...
		if(!empty($data) && !empty($data->list_id)) {
			...
			if($num_act > 0) {
				//�������� ���������� ����
				$update_default = "UPDATE bitrix24_template_calculation SET order_id=0 WHERE order_id=".$num_act;
				$query_update_default = mysql_query($update_default) or die(null);
			}
			else {
